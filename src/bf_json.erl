...
encode({market, BspMarket}) ->
    try
	iolist_to_binary(
	  mochijson2:encode({struct, [ %{bspMarket, BspMarket#'P:Market'.bspMarket},
				       {countryISO3, list_to_binary(BspMarket#'P:Market'.countryISO3)},
				       %% {couponLinks, BspMarket#'P:Market'.couponLinks},
				       {discountAllowed, BspMarket#'P:Market'.discountAllowed},
				       %% {eventHierarchy, eventId(BspMarket#'P:Market'.eventHierarchy)},
				       {eventTypeId, BspMarket#'P:Market'.eventTypeId},
				       {interval, list_to_binary(BspMarket#'P:Market'.interval)},
				       {lastRefresh, list_to_binary(BspMarket#'P:Market'.lastRefresh)},
				       {licenceId, BspMarket#'P:Market'.licenceId},
				       {marketBaseRate, list_to_binary(BspMarket#'P:Market'.marketBaseRate)},
				       {marketDescription, list_to_binary(BspMarket#'P:Market'.marketDescription)},
				       {marketDescriptionHasDate, BspMarket#'P:Market'.marketDescriptionHasDate},
				       {marketDisplayTime, list_to_binary(BspMarket#'P:Market'.marketDisplayTime)},
				       {marketId, BspMarket#'P:Market'.marketId},
				       {marketStatus, list_to_binary(BspMarket#'P:Market'.marketStatus)},
				       {marketSuspendTime, list_to_binary(BspMarket#'P:Market'.marketSuspendTime)},
				       {marketTime, list_to_binary(BspMarket#'P:Market'.marketTime)},
				       {marketType, list_to_binary(BspMarket#'P:Market'.marketType)},
				       {marketTypeVariant, list_to_binary(BspMarket#'P:Market'.marketTypeVariant)},
				       {maxUnitValue, list_to_binary(BspMarket#'P:Market'.maxUnitValue)},
				       {minUnitValue, list_to_binary(BspMarket#'P:Market'.minUnitValue)},
 				       {name, list_to_binary(BspMarket#'P:Market'.name)},
				       {numberOfWinners, BspMarket#'P:Market'.numberOfWinners},
				       {parentEventId, BspMarket#'P:Market'.parentEventId},
				       {runners, runners((BspMarket#'P:Market'.runners)#'P:ArrayOfRunner'.'Runner', [])},
				       {runnersMayBeAdded, BspMarket#'P:Market'.runnersMayBeAdded},
				       {timezone, list_to_binary(BspMarket#'P:Market'.timezone)},
				       {unit, BspMarket#'P:Market'.unit}
				     ]}))
    catch
...
runners([], R) -> R;
runners([H | T], R) ->
    runners(T, [{struct,[{'asianLineId', H#'P:Runner'.asianLineId},
			 {'handicap', list_to_binary(H#'P:Runner'.handicap)},
			 {'name', list_to_binary(H#'P:Runner'.name)},
			 {'selectionId', H#'P:Runner'.selectionId}
			]} | R]).
